...
def parse_line(instr):
    ...
    if instr[0] == 'toggle':
        # Toggle lights
        lights[c1[0]:c2[0]+1, c1[1]:c2[1]+1] = np.bitwise_xor(lights[c1[0]:c2[0]+1, c1[1]:c2[1]+1], True)
    elif instr[1] == 'on':
        # Turn lights on
        lights[c1[0]:c2[0]+1, c1[1]:c2[1]+1] = True
    else:
        # Turn lights off
        lights[c1[0]:c2[0]+1, c1[1]:c2[1]+1] = False
